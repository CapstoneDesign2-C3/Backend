...
public interface DetectionRepository {
    ...
    Page<DetectedObjectQueryResult.FixedObject> findFixedDetectionsByFilterAndIds(FixedObjectFilter filter,
        List<Long> fixedObjectIdBySearchInput, Pageable pageable);
